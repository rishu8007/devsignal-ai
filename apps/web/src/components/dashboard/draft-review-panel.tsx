...
export function DraftReviewPanel({ signalId, variationId, onApplied, onClose, onCreateResearch }: { signalId: string; variationId: string; onApplied: (generation: PublicGeneration) => void; onClose: () => void; onCreateResearch: () => void }) {
