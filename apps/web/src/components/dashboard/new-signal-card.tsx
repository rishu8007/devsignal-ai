    ...
    <section aria-labelledby="new-signal-heading" className="relative mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="p-5 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-indigo-600">New signal</p>
        ...
        <form className="mt-7 space-y-5">
          <div>
            <label htmlFor="topic" className="mb-2 block text-sm font-medium text-slate-700">Topic or feature</label>
            <input
              id="topic"
              name="topic"
              type="text"
              placeholder="e.g. Adding hybrid search to my RAG application"
              className="w-full rounded-lg border border-slate-200 bg-white px-3.5 py-3 text-sm text-slate-900 placeholder:text-slate-400"
            />
          </div>
          <div>
            <div className="mb-2 flex items-center justify-between gap-3">
              <label htmlFor="learning-notes" className="block text-sm font-medium text-slate-700">Learning notes</label>
              <span className="text-xs text-slate-400">0/4,000</span>
            </div>
            <textarea
              id="learning-notes"
              name="learning-notes"
              ...
              className="w-full resize-y rounded-lg border border-slate-200 bg-white px-3.5 py-3 text-sm leading-6 text-slate-900 placeholder:text-slate-400"
            />
          </div>
          <div className="grid gap-5 md:grid-cols-2">
            <SelectField id="content-type" label="Content type" options={selectOptions.contentType} />
            <SelectField id="audience" label="Primary audience" options={selectOptions.audience} />
          </div>
          <button
            type="button"
            disabled
            className="inline-flex w-full cursor-not-allowed items-center justify-center rounded-lg bg-indigo-600 px-4 py-3 text-sm font-semibold text-white opacity-45 sm:w-auto"
          >
    ...
    <div>
      ...
      <div className="relative">
        <select
          ...
          className="w-full appearance-none rounded-lg border border-slate-200 bg-white px-3.5 py-3 pr-10 text-sm text-slate-800"
        >
